public class WeatherStation
{
    ...
    {
            var r when r.WindDirection == WindDirection.Southerly || r.WindDirection == WindDirection.Easterly && r.Temperature > 20 => Outlook.Good,
            var r when r.WindDirection == WindDirection.Northerly => Outlook.Cool,
            var r when r.WindDirection == WindDirection.Easterly && r.Temperature <= 20 => Outlook.Warm,
            var r when r.WindDirection == WindDirection.Westerly => Outlook.Rainy,
